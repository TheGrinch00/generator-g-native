...
module.exports = class extends Generator {
    ...
    writing() {
        ...
        tsConfigJson.exclude = ["node_modules", "babel.config.js", "metro.config.js"];
        ...
        fs.rmSync(path.join(this.destinationRoot(), "components"), { recursive: true, force: true });
        fs.rmSync(path.join(this.destinationRoot(), "constants"), { recursive: true, force: true });
        fs.rmSync(path.join(this.destinationRoot(), "hooks"), { recursive: true, force: true });
        fs.rmSync(path.join(this.destinationRoot(), "navigation"), { recursive: true, force: true });
        fs.rmSync(path.join(this.destinationRoot(), "screens"), { recursive: true, force: true });
    }
